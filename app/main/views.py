...
def index():
    ...
    hacker = get_articles_from_source('hacker-news', '1')
    ...
    return render_template("index.html", title=title, sources=sources, hacker=hacker, washington=washington, wallstreet=wallstreet, techradar=techradar, reuters=reuters, espn=espn)
